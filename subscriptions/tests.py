...
class SubscribeTestPost(TestCase):
    ...
    def test_subscription_email_to(self):
        email = mail.outbox[0]
        expect = ['contato@eventif.com.br', 'vitor.rocha@aluno.riogrande.ifrs.edu.br']
        self.assertEqual(expect, email.to)
    
    def test_subscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn('Vitor Rocha', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('vitor.rocha@aluno.riogrande.ifrs.edu.br', email.body)
